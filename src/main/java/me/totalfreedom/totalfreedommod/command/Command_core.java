...
@CommandParameters(description = "Manage the core.", usage = "/<command> <list | clean | reload | | setrank <username> <rank> | <add | remove | info> <username> | corereload | stop>", aliases = "control,servercontrol,corecontrol,executive")
