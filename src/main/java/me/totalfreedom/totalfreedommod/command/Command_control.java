...
@CommandParameters(description = "Manage admins.", usage = "/<command> <list | clean | reload | debug <username> <rank> | setrank <username> <rank> | <add | remove | info> <username>>")
public class Command_control extends FreedomCommand
{
