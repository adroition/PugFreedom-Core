...
LifeUtils is a Spigot server plugin designed primarily to support the [iGetOP FreeOP Server](http://igetop-forums.boards.net/). However, you are more than welcome to adapt the source for your own server.
